...
vscode.postMessage({ messageType: 'send-parameters', data: parameters });
vscode.postMessage({ messageType: 'send-colors', data: parameters });
...
window.addEventListener('message', e => {
    ...
    if (message.messageType == 'send-colors') {
        gridStylerWorker.postMessage(message);
    }
